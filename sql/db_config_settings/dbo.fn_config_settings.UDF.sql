DROP FUNCTION dbo.fn_config_settings
GO

/*
	<name>dbo.fn_config_settings</name>
	<summary>
		This function works as a configuration settings lookup tool for environment-specific settings.
	</summary>
...
*/
CREATE FUNCTION dbo.fn_config_settings
(
	@key varchar(4000)
)  
...
GO
GRANT EXECUTE ON dbo.fn_config_settings TO Public